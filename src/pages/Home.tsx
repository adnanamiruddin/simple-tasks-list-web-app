...
const Home = ({ data, handleDeleteTask }: IHomeProps) => {
  return (
    <div className="bg-yellow-500 w-full h-screen pt-10 overflow-auto">
      ...
      <Link
        to="/add"
        className="bg-green-600 fixed bottom-4 right-2 p-2 pt-0.5 font-bold text-2xl rounded-lg cursor-pointer md:text-5xl md:p-4 md:pt-0.5 md:bottom-8 md:right-9 hover:brightness-125 hover:text-gray-200"
      >
        +
      </Link>
    </div>
